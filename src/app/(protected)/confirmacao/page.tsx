...
import { ACCENT, ACCENT_LIGHT, WHATSAPP_LINK, WHATSAPP_NUMERO, buildWhatsAppUrl, formatPhoneDisplay } from "@/config/constants";
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <div className="mt-4 max-w-sm w-full rounded-2xl border border-neutral-100 bg-white shadow-sm px-6 py-4 text-left space-y-1">
            ...
            <a
              ...
              href={config?.telefone ? buildWhatsAppUrl(config.telefone) : WHATSAPP_LINK}
              target="_blank"
            ...
            >
              ...
              {config?.telefone ? formatPhoneDisplay(config.telefone) : WHATSAPP_NUMERO}
            </a>
          </div>
