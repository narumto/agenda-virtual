    ...
    >
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div>
              ...
              >
                {configuracao?.nome_site ? configuracao.nome_site.replace(/ clinic$/i, "") : "Cristiane Vasconcelos"}
              </h1>
              <p className="text-[10px] uppercase tracking-widest text-neutral-400">
                {configuracao?.nome_site && configuracao.nome_site.toLowerCase().endsWith("clinic") ? "Clinic" : "Clinic"}
              </p>
            </div>
          </div>
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 py-10 md:px-10">
        ...
        >
          ...
          <a
            id="btn-contact"
            href={configuracao?.telefone ? `https://wa.me/${configuracao.telefone.replace(/\D/g, "")}` : WHATSAPP_LINK}
            target="_blank"
          ...
          >
            ...
            {configuracao?.telefone || WHATSAPP_NUMERO}
          </a>
        </div>
      </main>
    </div>
